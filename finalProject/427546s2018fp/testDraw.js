...
/*window.onload = function () {
    ...
    // choose image
    if (document.getElementById('kim').checked) {
        oImage.src = '/image/kim.jpg';
    }
    else if (document.getElementById('lilo').checked) {
        oImage.src = '/image/lilo.jpg';
    }
    else if (document.getElementById('mickey').checked) {
        oImage.src = '/image/mickey.jpg';
    }
    ...
    function change() {
        ...
        else if (document.getElementById('peter').checked) {
            oImage.src = '/image/peter.jpg';
        }
        else if (document.getElementById('puppies').checked) {
            oImage.src = '/image/puppies.jpg';
        }
